...
// 	TCHAR szDigit[8];
// 	SYSTEMTIME systime;
// 	_tcsncpy_s((TCHAR *)szDigit,8,szTime,4);
// 	systime.wYear = _ttoi((LPCTSTR)szDigit);
// 
// 	_tcsncpy_s((TCHAR *)szDigit, 8, &szTime[5], 2);
// 	systime.wMonth = _ttoi((LPCTSTR)szDigit);
// 
// 	_tcsncpy_s((TCHAR *)szDigit, 8, &szTime[8], 2);
// 	systime.wDay = _ttoi((LPCTSTR)szDigit);
// 
// 	_tcsncpy_s((TCHAR *)szDigit, 8, &szTime[11], 2);
// 	systime.wHour = _ttoi((LPCTSTR)szDigit);
// 
// 	_tcsncpy_s((TCHAR *)szDigit, 8, &szTime[14], 2);
// 	systime.wMinute = _ttoi((LPCTSTR)szDigit);
// 
// 	_tcsncpy_s((TCHAR *)szDigit, 8, &szTime[17], 2);
// 	systime.wSecond = _ttoi((LPCTSTR)szDigit);
